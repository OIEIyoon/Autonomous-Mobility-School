...
class Lane:
    def __init__(self, w = 0.5, left_lower = (0, 200, 180), left_upper = (100, 255, 255),
                 ...
                 pointx = [62, 124, 466, 542], pointy = [346, 277, 272, 349],
                 realx = [0.31, 0.455, 0.455, 0.30], realy = [0.15, 0.15, -0.14, -0.14]):
        self.H = Homography(pointx, pointy, realx, realy)
...
class StopLine:
    def __init__(self, pre_clearance, alpha_c = 0.9, lower_rgb = (0, 140, 230), upper_rgb = (100, 200, 255),
                 pointx = [62, 124, 466, 542], pointy = [346, 277, 272, 349],
                 realx = [0.31, 0.455, 0.455, 0.30], realy = [0.15, 0.15, -0.14, -0.14]):
        self.H = Homography(pointx, pointy, realx, realy)
...
if __name__ == "__main__":
    lane = Lane(w = 0.5, left_lower = (100, 225, 100), left_upper = (105, 235, 105),
                 right_lower = (225, 100, 100), right_upper = (235, 105, 105))
    stopline = StopLine(2, 0.9, (100, 100, 225), (105, 105, 235))